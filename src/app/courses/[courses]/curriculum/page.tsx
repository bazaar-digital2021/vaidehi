...
export default function BasicBscNursingCurriculumPage() {
    return (
        <div className="container mx-auto px-4 py-12">
            <h1 className="text-3xl font-bold mb-6">B.Sc. Nursing Curriculum</h1>

            <div className="prose max-w-none">
                <p className="lead text-lg">
                    The B.Sc. Nursing program follows a comprehensive curriculum designed according to the guidelines
                ...
                <div className="mt-8">
                    ...
                    <p>
                        The 4-year program is structured to provide a progressive learning experience, starting with
