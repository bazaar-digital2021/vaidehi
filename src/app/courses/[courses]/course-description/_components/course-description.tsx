export default function CourseDescription({ courseTitle, courseDuration }: { courseTitle: string, courseDuration: number }) {

    return (
        <div className="container mx-auto px-4 py-12">
            <h1 className="text-3xl font-bold mb-6">{courseTitle} Nursing Course Description</h1>

            <div className="prose max-w-none">
                <div>
                    <h2 className="text-2xl font-semibold mb-3">Program Overview</h2>
                    <p>
                        The {courseTitle} Nursing program is a {courseDuration}-year undergraduate degree that prepares students for a career in nursing.
                ...
                <div className="mt-8">
                    ...
                    <p>The {courseTitle} Nursing program aims to:</p>
                ...
                <div className="mt-8">
                    ...
                    <p>Graduates of the {courseTitle} Nursing program can pursue various career paths, including:</p>
                ...
                <div className="mt-8">
                    ...
                    <p>
                        After completing {courseTitle} Nursing, graduates can pursue higher education in nursing, such as:
                    </p>
                    <ul className="list-disc ml-6 mt-2">
                ...
                <div className="bg-primary/10 p-6 rounded-lg mt-8">
                    <h2 className="text-2xl font-semibold mb-3">Why Choose Vaidehi Institute for {courseTitle} Nursing?</h2>
